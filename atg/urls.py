...
from .views.remote_ocr_views import RemoteOCRInstructionsView, RemoteOCRFetchJobView, RemoteOCRResolveJobView
...
urlpatterns = [
    ...
    path('api/v1/remote-ocr/instructions/', RemoteOCRInstructionsView.as_view(), name='remote_ocr_instructions'),
    path('api/v1/remote-ocr/fetch-job/', RemoteOCRFetchJobView.as_view(), name='remote_ocr_fetch'),
    path('api/v1/remote-ocr/resolve-job/', RemoteOCRResolveJobView.as_view(), name='remote_ocr_resolve'),
