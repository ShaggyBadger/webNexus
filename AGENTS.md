...
# Output Rules
- Be concise. Skip introductory pleasantries and post-code summaries.
- Avoid repeating entire files when making edits; use targeted patches or diffs.
- Do not paste raw tool logs unless an error explicitly occurs.

# Project Guidelines
- See instructions/development_conventions.md for architecture standards.
