...
# ==============================================================================
# PRODUCTION SECURITY HARDENING (HTTPS/SSL)
# ==============================================================================
# These settings activate ONLY when DEBUG=False (Production).
# They ensure all data is transmitted over encrypted channels to prevent
...
# Zoho SMTP for Tank Chart Email Delivery
EMAIL_BACKEND = "django.core.mail.backends.smtp.EmailBackend"
EMAIL_HOST = os.environ.get("EMAIL_HOST", "smtp.zoho.com")
EMAIL_PORT = int(os.environ.get("EMAIL_PORT", 587))
EMAIL_USE_TLS = os.environ.get("EMAIL_USE_TLS", "True") == "True"
EMAIL_HOST_USER = os.environ.get("EMAIL_HOST_USER", "josh@thejoshproject.xyz")
EMAIL_HOST_PASSWORD = os.environ.get("ZOHO_EMAIL_HOST_PASSWORD", "")
DEFAULT_FROM_EMAIL = os.environ.get(
    "DEFAULT_FROM_EMAIL",
    "webNexus Tank Charts <josh@thejoshproject.xyz>",
)
EMAIL_TIMEOUT = 30
...
MISSIONLOG_REPORT_USER_RATE_PER_DAY = int(
    os.environ.get("MISSIONLOG_REPORT_USER_RATE_PER_DAY", "10")
)
MISSIONLOG_REPORT_IP_RATE_PER_DAY = int(
    os.environ.get("MISSIONLOG_REPORT_IP_RATE_PER_DAY", "30")
)
MISSIONLOG_PRODUCTION_GPH_TARGET = float(
    os.environ.get("MISSIONLOG_PRODUCTION_GPH_TARGET", "7000")
)
