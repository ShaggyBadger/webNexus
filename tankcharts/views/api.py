...
class TankChartMetaAPIView(APIView):
    ...
    def get(self, request, store_num: int, tank_index: int):
        ...
        payload = {
            ...
            "veeder_observation_count": chart.veeder_observation_count,
            "estimation_sample_count": chart.estimation_sample_count,
            "capacity_gallons": chart.capacity_gallons,
            "capacity_source": chart.capacity_source,
            "capacity_status": chart.capacity_status,
            "geometry_implied_capacity_gallons": chart.geometry_implied_capacity_gallons,
            "generated_at": chart.generated_at.isoformat(),
