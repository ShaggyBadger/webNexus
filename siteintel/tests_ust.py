...
class USTBackendTests(TestCase):
    ...
    def test_atomic_update(self):
        ...
        old_permit = USTPermit.objects.create(store=self.store, is_active=True, **permit_data)
    ...
    def test_api_endpoints(self):
        ...
        response = self.client.post(f'/siteintel/api/stores/{self.store.id}/ust-verifications/', {
        ...
        # PATCH Permit (Update)
        response = self.client.patch(f'/siteintel/api/stores/{self.store.id}/ust-permit/', {
