...
urlpatterns = [
    ...
    path(
        ...
        views.StoreUpdateUpdateView.as_view(),
        name="proposal_edit",
    ),
    path(
        "proposals/<int:pk>/delete/",
        views.StoreUpdateDeleteView.as_view(),
        name="proposal_delete",
    ),
    # Site Intelligence Views
    path("site/<int:pk>/", views.LocationDetailView.as_view(), name="location_detail"),
    path(
        "site/<int:location_id>/update-intel/",
        views.SiteIntelligenceUpdateView.as_view(),
        name="intel_update",
    ),
    path(
        "site/<int:location_id>/edit-map/",
    ...
    path(
        "init-location/<int:store_id>/",
        views.initialize_location_for_store,
        name="init_location",
    ),
